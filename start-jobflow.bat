...
cd /d D:\1_Working\Projects\jobflow

set "NODE_DIR=C:\Users\26396\AppData\Roaming\fnm\node-versions\v24.18.1\installation"
...
start "JobFlow-API" cmd /k "cd /d D:\1_Working\Projects\jobflow\api && .\.venv\Scripts\python.exe -m uvicorn app.main:app --port 8000"
goto check_front
...
start "JobFlow-Vite" cmd /k "cd /d D:\1_Working\Projects\jobflow\web && set PATH=%NODE_DIR%;%PATH% && npm run dev"
...
start "JobFlow-Desktop" cmd /k "cd /d D:\1_Working\Projects\jobflow\web && set PATH=%NODE_DIR%;%PATH% && npm run electron:dev"
